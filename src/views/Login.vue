...
<template>
  <div class="login-container">
    <div class="login-card">
      ...
      <div class="login-card__social-login">
      ...
      <form>
        <div class="login-card__email-login">
          <input type="text" placeholder="Enter Email" name="email" autocomplete="off" v-model="email" />
        </div>
...
.login-card__social-login {
  display: flex;
  justify-content: center;
  align-items: center;
}

.login-card__social-login > button {
  background: #fff;
...
.login-card__seperator span {
  background: #fff;
  padding: 0 10px;
}

.login-card__email-login{
  display: flex;
